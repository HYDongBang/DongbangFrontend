...
export const EDIT_QUESTION = gql`
    mutation editQuestion($id: ID!, $subject: String, $options: [String], $action: ACTIONS!) {
...
export const CREATE_QUESTION = gql`
    mutation createQuestion($subject: String!, $type: TYPE!, $options: [String]) {
...
export const EDIT_CLUB = gql`
    mutation editClub($action: ACTIONS!, $application_description: String) {
